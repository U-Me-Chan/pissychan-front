...
router.post('/delete', require('./handler-delete-post'))
router.post('/forget', require('./handler-forget-post'))
router.get('/:tag/:thread_id/delete', require('./handler-delete'))
router.get('/:tag/:thread_id/forget', require('./handler-forget'))
